...
const Header = () => {
  ...
  return (
    <header className="h-[47px] md:h-16 sticky top-0 z-50 border border-[#D7D7D7]">
      <div className="relative max-w-[360px] md:max-w-[1100px] mx-auto h-full flex justify-center items-center">
        ...
        {pathname === "/category" && (
          <>
            <button
              onClick={handleExit}
              className="absolute left-5 hidden md:flex w-[120px] h-[38px] items-center justify-center bg-[#F7F7F8] font-semibold text-[16px] text-[#323232] border border-[#E5E5E5] rounded"
            >
              나가기
            </button>
            ...
            <button
              onClick={handleExit}
              className="absolute left-4 flex md:hidden"
            >
